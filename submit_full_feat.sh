...
#SBATCH --gres=gpu:1
#SBATCH -t 24:00:00
#SBATCH -o /dss/dssfs02/lwp-dss-0001/pn67na/pn67na-dss-0000/ga25ley2/logs/sparse-crosscoders-prott5/proteingym_full_feat_%j.out
#SBATCH -e /dss/dssfs02/lwp-dss-0001/pn67na/pn67na-dss-0000/ga25ley2/logs/sparse-crosscoders-prott5/proteingym_full_feat_%j.err
